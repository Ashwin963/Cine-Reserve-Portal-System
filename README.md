...
In login table - 3 columns(name,email,password)

In sign table - 3 columns(name,email,password)

In bookings table - 6 columns(name,movieDate,movieTime,movieName,movieTheatre,seat)

In pay table - 5 columns(name,bank,cardNumber, expiryDate, cvv)
